...
from src.legacy.corrector import (
    INTERVENTION_HEDGE,
...
from src.legacy.router import Decision, RoutingOutcome
...
def test_corrector_system_prompt_includes_restraint_guidance():
    ...
    from src.legacy.corrector import CORRECTOR_SYSTEM
...
def test_ledger_surfaces_router_reason_for_unverifiable_in_principle():
    ...
    from src.legacy.corrector import _format_user_message, Intervention
...
def test_ledger_surfaces_judge_justification_for_inconclusive():
    ...
    from src.legacy.corrector import _format_user_message, Intervention
    from src.legacy.verifiers.retrieval_verifier import (
...
def test_ledger_falls_back_to_generic_reason_when_verdict_missing():
    ...
    from src.legacy.corrector import _format_user_message

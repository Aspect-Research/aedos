...
_SEEDS_FILE = Path(__file__).parents[3] / "seeds" / "v0_15" / "predicate_translation.json"
_SEED_VERSION_FILE = Path(__file__).parents[3] / "seeds" / "v0_15" / "SEED_VERSION.txt"
_LOAD_SCRIPT = Path(__file__).parents[3] / "seeds" / "v0_15" / "load_seeds.py"

...
from src.aedos_v0_15.utils.http_cache import CacheEntry, CachingHTTPClient, LRUHTTPCache
...
class TestCachingHTTPClient:
    ...
    def test_cache_populated_after_first_request(self):
        ...
        with patch("src.aedos_v0_15.utils.http_cache.httpx.Client", return_value=mock_cm):

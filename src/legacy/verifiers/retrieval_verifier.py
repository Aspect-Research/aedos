...
from src.legacy.pattern_registry import PatternRegistry, Pattern
from src.legacy.verifiers.comparative import (
    ComparativeClaim,
    comparative_queries,
    detect_comparative,
)
...
def default_search(query: str) -> list[Snippet]:
    ...
    """
    try:
        from src.legacy.verifiers.scrapers import search_wikipedia
